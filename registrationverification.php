...
if(!isset($_GET['flduseremail'])){ 
	if(!isset($_POST['flduseremail'])){ 
		header('location: registration.php?error=Something Went Wrong. User Not Logged In!');
		exit;
	}
}
    ...
    <script>
        ...
        const countdownTimer = setInterval(function() {
            ...
            if (timeLeft <= 0) {
                ...
                window.location.href = 'registration.php?error=OTP Code Expired. Please Try Again.&bool='+true;
            }
        }, 1000);
